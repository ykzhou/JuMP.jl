...
export
# Objects
    Model, Variable, AffExpr, QuadExpr, LinearConstraint, QuadConstraint, SOCConstraint,
...
function Model(;solver=UnsetSolver())
    ...
    Model(QuadExpr(),:Min,LinearConstraint[], QuadConstraint[],SOSConstraint[],SOCConstraint[],
